...
mod test {
    ...
    fn basic_play() {
        ...
        assert_eq!(engine.state, EngineState::Guessing);
        engine.add_letter('T');
        assert_eq!(engine.current_guess, vec!['T']);
        assert_eq!(engine.state, EngineState::Guessing);
        engine.add_letter('E');
        assert_eq!(engine.current_guess, vec!['T', 'E']);
        assert_eq!(engine.state, EngineState::Guessing);
        engine.add_letter('A');
        assert_eq!(engine.current_guess, vec!['T', 'E', 'A']);
        assert_eq!(engine.state, EngineState::Guessing);
        engine.add_letter('S');
        assert_eq!(engine.current_guess, vec!['T', 'E', 'A', 'S']);
        assert_eq!(engine.state, EngineState::Guessing);
        assert_eq!(engine.guesses, Vec::<Vec<LetterSlot>>::new());
